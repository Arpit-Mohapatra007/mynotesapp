...
void main(){
  group('Mock Authentication', (){
    ...
    test('Should be able to intialize in less than 2 seconds', ()async{
      ...
      test('LogIn use should be able to get verified', (){
...
@override
  ...
  const user = AuthUser(isEmailVerified: false, email: 'foobar@k.com', id: 'lol');
  _user = user;
  ...
  Future<void> sendEmailVerification() async {
    ...
    const newUser = AuthUser(isEmailVerified: true, email: 'foobar@k.com', id: 'lol');
    _user = newUser;    
  }
}